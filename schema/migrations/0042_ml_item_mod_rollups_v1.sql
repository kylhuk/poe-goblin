CREATE TABLE IF NOT EXISTS poe_trade.ml_item_mod_rollups_v1 (
...
CREATE MATERIALIZED VIEW IF NOT EXISTS poe_trade.mv_item_mod_rollups_v1
TO poe_trade.ml_item_mod_rollups_v1
AS
SELECT
    league,
    item_id,
...
INSERT INTO poe_trade.ml_item_mod_rollups_v1
SELECT
    league,
    item_id,
    groupArrayState(mod_token) AS mod_tokens_state,
...
GRANT SELECT ON poe_trade.ml_item_mod_rollups_v1 TO poe_api_reader;
GRANT SELECT ON poe_trade.ml_item_mod_rollups_v1 TO poe_ingest_writer;
