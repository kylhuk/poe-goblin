CREATE TABLE IF NOT EXISTS poe_trade.silver_v3_sold_items_lookup (
...
INSERT INTO poe_trade.silver_v3_sold_items_lookup
SELECT
...
SELECT
    ...
    sold_at,
    price
FROM poe_trade.silver_v3_sold_items_lookup;
